...
<div class="container-wrapper">
    <div class="container">
        ...
        <!-- spring form action -->
        <form:form commandName="customer" class="form-horizontal">

        <div class="well col-xs-10 col-sm-10 col-md-6 col-sm-offset-1 col-md-offset-3">
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-ad-6">
            <address>
            ...
            <div class="col-xs-6 col-sm-6 col-ad-6 text-right">
